...
- [x] 03-04-PLAN.md — Wave 2: useTransacoes.ts + useTransacoesSummary.ts + summary tests GREEN

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 03-05-PLAN.md — Wave 3: TransactionSheet.tsx (create + edit + delete bottom-sheet)
...
- [x] 04-01-PLAN.md — Wave 0: TDD Red phase — 3 failing test files (faturamento.test.ts, getByYear extension, useFaturamento.test.ts)

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 04-02-PLAN.md — Wave 1a: faturamento.ts pure functions + transacaoService.getByYear (tests GREEN)
- [x] 04-03-PLAN.md — Wave 1b: useFaturamento hook (tests GREEN)

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 04-04-PLAN.md — Wave 2: FaturamentoGauge + FaturamentoAlert components
...
| 4. Inteligencia de Faturamento | 4/5 | In Progress|  |
